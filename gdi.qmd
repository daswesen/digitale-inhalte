...
-   Und leider auch viele Data-Science-Modelle.
...
## Der t-Test: Einer von vielen Tests
...
- Metriken: Support, Confidence, Lift  
- Anwendung: Content-Empfehlungen, Modul-Kombinationen auf Seiten  
...
- Nutzt bedingte Wahrscheinlichkeiten  
- Annahme: Merkmale sind unabhängig  
- Anwendung: einfache Textklassifikation, Nutzer-Kategorisierung  
...
## Mini-EDA für Content-Daten

- Erste Strukturierung: Variablen-Check, Ausreißer, Korrelationen  
- Typische Variablen: Thema, Format, Scrolltiefe, Viewtime, CTR  
- Drei Fragen:
  - Welche Inhalte clustern natürlich?  
  - Welche Variablen hängen zusammen?  
  - Welche Themen sind Ausreißer?  

---

## Text Mining (Light)

- Keyword-Häufigkeiten (Unigramme, Bigramme)  
- Themenpattern in Überschriften/Teasern  
- Sentiment in Kommentaren oder Feedback  
- Unterstützt qualitative Inhaltsanalyse  
...
- LLM-Embeddings als Vektoren → Ähnlichkeitsmessung  
- Anwendung:
  - Content-Clustering  
  - Recommendations  
  - Themenräume identifizieren  
- Robust gegenüber Synonymen und Wortvarianten  

---

## Beispiel: Newsletter-Content analysieren

- 10–20 Titel in Embeddings wandeln  
- Cluster bilden (z. B. 2–3 Gruppen)  
- Interpretation: Welche Themen ziehen ähnlich?  
- Verbindung zu KPI-Folien aus Sitzung 6 herstellen  

---

## Typische Fehler im Data Mining

- Zu kleine Stichproben → instabile Muster  
- Korrelationen als Kausalität interpretieren  
- Modelle ohne Validierung einsetzen  
- Fehlende Segmenttests (z. B. neue vs. wiederkehrende Nutzer)  
